...
from services.preprocess import clean_data
...
MIN_CHUNK_SIZE_CHARS = 700  # The minimum size of each text chunk in characters
MIN_CHUNK_LENGTH_TO_EMBED = 20  # Discard chunks shorter than this
...
def get_text_chunks(
    ...
    """
    Split a text into chunks of ~CHUNK_SIZE tokens, based on page splitter, punctuation and newline boundaries.
