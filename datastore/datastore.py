...
class DataStore(ABC):
    ...
    async def query(
        self, queries: List[Query], query_type: str = "semantic"
    ) -> List[QueryResult]:
        """
        ...
        return await self._query(queries_with_embeddings, query_type)

    @abstractmethod
    async def _query(
        self, queries: List[QueryWithEmbedding], query_type: str = "semantic"
    ) -> List[QueryResult]:
        """
